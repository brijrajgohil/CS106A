...
public class MemorySoln extends GraphicsProgram {
	...
	/* The state of the game */
	 ...
	 /**
	  * Run the heartbeat of the game. Update the clock 
	  * and if the game is waiting to resolve a match, resolve
	  * it!
	  */
	 ...
	 /**
	  * Put black square on top of all the colored cards
	  * to hide them.
	  */
	 ...
	 /**
	  * Place a single card with a give color. Repeatedly
	 ...
	 /**
	  * Returns true if a given rows column is occupied
	  */
	  ...
	  * a given color. Adds the card to the screen and 
	  * returns it
	  */
	 ...
	 /**
	  * Translated a row number into pixel value
	  */
	 ...
	 /**
	  * Translated a column number into a pixel value
	  */
